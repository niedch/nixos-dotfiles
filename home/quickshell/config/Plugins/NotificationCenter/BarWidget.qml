...
BarWidget {
  id: widget
  moduleName: "quickshell.notification-center"

  readonly property color textColor: Notifications.dnd ? Color.urgent : Color.foreground

  implicitHeight: Constants.barHeight
  implicitWidth: glyph.implicitWidth + (Notifications.unread > 0 ? badge.width + 4 : 0) + 15
